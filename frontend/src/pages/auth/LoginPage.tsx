  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user.role !== "admin") {
        toast.error("Admin access required. Only administrators can login.");
        setLoading(false);
        return;
      }
      ...
      >
        ...
        <div className="flex gap-3 mb-6">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 glass border border-white/10 py-3 rounded-xl text-sm hover:border-white/20 transition-colors"
          >
            <Mail size={16} /> Google
          </a>
          <a
