...
import { ShoppingCart, Star, ShieldCheck, Truck, ArrowLeft, ExternalLink } from 'lucide-react';
  ...
  if (error || !product) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <p className="text-white/40 mb-6">This product might have been removed or is currently unavailable.</p>
      ...
      <div className="bg-[#1a1c23] border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="p-8 lg:p-12 flex flex-col">
              ...
              {product.rating && (
                <div className="ml-auto flex flex-col items-end">
                  ...
                  <div className="flex items-center gap-1.5 bg-white/5 px-3 py-1.5 rounded-lg border border-white/5">
                    <Star size={18} className="text-[#ff9900]" fill="currentColor" /> 
            ...
            {/* Buy Action */}
            <a 
              href={`/api/public/redirect/${product._id}`} 
              target="_blank" 
              rel="noreferrer"
            ...
            <div className="space-y-8 flex-1">
              {description && (
                <div>
                  <h3 className="text-lg font-semibold text-white mb-3">About this item</h3>
